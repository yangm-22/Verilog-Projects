...
wire write_reg_file /*synthesis keep*/, result_mux_select/*synthesis keep*/;
wire [1:0] op1_mux_select /*synthesis keep*/, op2_mux_select/*synthesis keep*/;
wire start_delay_counter /*synthesis keep*/, enable_delay_counter/*synthesis keep*/;
wire commit_branch /*synthesis keep*/, increment_pc/*synthesis keep*/;
wire alu_add_sub /*synthesis keep*/, alu_set_low/*synthesis keep*/, alu_set_high/*synthesis keep*/;
wire load_temp_register /*synthesis keep*/, increment_temp_register/*synthesis keep*/, decrement_temp_register/*synthesis keep*/;
wire [1:0] select_immediate /*synthesis keep*/;
wire [1:0] select_write_address /*synthesis keep*/;
...
//more wires
wire [3:0] stepper_signals; // 4 bits
